...
For each day/session record unexpected disconnects, failed controls, app crashes, reboot/re-pair events, lost captures, notification failures, stalled transfers, cloud/service failures, and recovery steps. Record denominator where possible rather than only anecdotes.
