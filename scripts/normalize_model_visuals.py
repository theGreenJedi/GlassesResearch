...
The original acquired image remains untouched. This script creates a consistent
transparent PNG canvas for catalog/report-card presentation without changing
product geometry, color, logos, lenses, controls, or hardware.
"""
