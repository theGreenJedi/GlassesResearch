...
def main():
    ...
    run(ROOT/"scripts/build_family_tree_surfaces.py","--site-root",DEST,"--families",ROOT/"data/family-trees.json","--additional-families",ROOT/"data/family-trees-bounded.json")
