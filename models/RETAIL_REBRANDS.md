...
| VITURE Phantom Beast | VITURE Beast / GLS-0082 | Co-branded derivative alias; does not add a model beyond GLS-0082 | VITURE states that the collector's edition retains Beast's core XR hardware; [VITURE Beast](/models/catalog/gls-0082/); [evidence](../evidence/EV-0085-VITURE-Phantom-Beast-primary-derivative.md) |
