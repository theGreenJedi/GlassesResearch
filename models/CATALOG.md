...
| Nautica / Lucyd | Corsair | Audio smart sunglasses | Primary + major retail; current | Canonical GLS-0164; preserve the named retail model rather than collapsing it into a generic Lucyd family | [Lucyd Corsair](https://lucyd.co/products/corsair) |
...
| CORNMI | NeoVista A8 Lite / X7 Lite / X7 / X7 Pro | Tethered and Android-enabled XR displays | Primary + commercial; current | First-party spec contradictions merit provenance/NDI work; X7 Pro adds an Android ownership boundary | [display-glasses profiles](PROFILES_2026_09_04_DISPLAY_GLASSES.md) |
| ASUS | AirVision M1 | Tethered display/XR glasses | Primary; current | Separate generic DisplayPort behavior from ASUS AirVision multi-screen software dependence | [ASUS AirVision M1](https://www.asus.com/us/displays-desktops/glasses/airvision/asus-airvision-m1/) |
| Lenovo | Legion Glasses / Legion Glasses Gen 2 | Tethered display/XR glasses | Primary; Gen 2 current, first generation legacy | T1/Yoga predecessor naming and host-software behavior merit lineage mapping | [Lenovo Legion Glasses Gen 2](https://www.lenovo.com/us/en/p/accessories-and-software/vr-headsets/vr-headsets_smart-glasses/gy21r10236) |
| Huawei | HUAWEI Vision Glass | Tethered display/XR glasses | Primary; region-limited/historical retail | DP interoperability, compatibility-list and software/firmware dependence merit mapping | [HUAWEI Vision Glass](https://consumer.huawei.com/cn/wearables/vision-glass/) |
| Meizu / DreamSmart / StarV | StarV View | Tethered display/XR glasses | Primary; current China retail | Birdbath cinema-display branch is separate from StarV Air/Air2 waveguide lineage | [display-glasses profiles](PROFILES_2026_09_04_DISPLAY_GLASSES.md) |
| OPPO | Air Glass / Air Glass 2 / Air Glass 3 | Monocular assisted-reality display lineage | Primary; original commercially sold, Air Glass 2/3 concept/prototype | Useful commercial-vs-prototype boundary; original uses waveguide display and phone/watch host ecosystem | [OPPO Air Glass](https://www.oppo.com/cn/newsroom/press/480/) |
| TCL / RayNeo | NXTWEAR AIR | Tethered display/XR glasses | Primary + commercial; legacy | Second-generation NXTWEAR identity; China-market Thunderbird/RayNeo naming relationship remains a lineage target | [TCL NXTWEAR AIR specs](https://www.tcl.com/eu/en/glasses/tcl-nxtwear-air/specifications) |
...
| Rokid | Rokid Glass / Glass 2 | Legacy enterprise standalone AR | Primary chronology + canonical `GLS-0061/0062` | Reconstruct generation-specific internals; Glass 2 era corrected to 2020 | [Rokid lineage](../lineages/ROKID.md) |
| Rokid | [Rokid Glass 3](RokidGlass3/README.md) | Standalone enterprise AR glasses | Primary manual/developer/security documentation; canonical `GLS-0184`; current | `RG301/RG303`, YodaOS-Sprite Enterprise, direct Android Studio/debug workflow and service-loss investigation | [Glass 3 developer guide](https://x-docs.rokid.com/docs/en/downloads/demo-guide.html) |
| Rokid | [Rokid Glasses](RokidGlasses/README.md) | Integrated display AI/AR glasses | Primary + existing report-card research; canonical `GLS-0064`; current | Terminal SDK, companion/account boundary, translation and service-survival investigation | [Rokid Glasses](https://global.rokid.com/products/rokid-glasses) |
| Rokid | [Rokid AI Glasses / Style / Neo](RokidAIStyle/README.md) | Display-free camera/audio AI glasses | Primary security + retail; canonical `GLS-0063`; current | `RV203`; preserve Style/Neo aliases, test SDK/offline/app boundary, resolve Bolon `RV201/RV202` relationship | [Rokid Style](https://global.rokid.com/products/rokid-ai-glasses-style) |
| Rokid | [Rokid Air Pro](RokidAirPro/README.md) | Camera-equipped host-driven AR glasses | Primary chronology/developer evidence + commercial history; canonical `GLS-0182` | UXR SDK target; camera/optics differences from Air require separate privacy/owner-control evaluation | [Rokid Air/Air Pro developer evidence](https://forum.rokid.com/post/detail/365) |
| Rokid | [Rokid Max Pro](RokidMaxPro/README.md) | 6DoF spatial/XR glasses | Primary AR Studio/security documentation + procurement history; canonical `GLS-0183` | `RA202`; separate Max Pro sensors/display from Station Pro/YodaOS-Master compute | [Rokid AR Studio](https://arstudio.rokid.com/) |
| Rokid | [Rokid Max 2](RokidMax2/README.md) | Tethered display/XR glasses | Primary + canonical `GLS-0094`; current | Host-driven display branch; resolve storefront Station 2 spec contamination and generic DisplayPort behavior | [Rokid AR lineup](https://global.rokid.com/collections/rokid-ar-glasses-series) |
| Rokid | [Rokid AR Spatial](RokidARSpatial/README.md) | Max 2 + Station 2 spatial-computing system | Primary; current bundle | Preserve as system investigation without counting a second Max 2 eyewear model; map YodaOS-Master and Station 2 ownership boundary | [Rokid AR Spatial](https://global.rokid.com/products/rokid-ar-spatial) |
| Rokid | [Rokid AR Joy 2](RokidARJoy2/README.md) | Max 2 + original Rokid Station entertainment system | Primary; current bundle | Preserve original-Station versus Station 2 boundary; storefront copy currently conflicts with lineup comparison | [Rokid AR Joy 2](https://global.rokid.com/products/rokid-ar-joy-2) |
| Rokid / Bolon | Bolon AI Glasses (`RV201/RV202`) | Display-free camera/audio AI co-brand/variant | Primary security listing + current product history; hardware distinction unresolved | Keep as lineage/registry variant until evidence proves materially distinct hardware from `RV203`; do not inflate canonical count | [Rokid security center](https://global.rokid.com/pages/security-center) |
...
| OICIIDO / Ear Dance lead | unresolved Ear Dance audio/translation glasses | Audio/translation smart glasses | Commercial/community lead; needs evidence | Resolve KM03/W100 identity and OEM lineage before admission | [Walmart lead](https://www.walmart.com/ip/16914411854) |
| Coucur | unresolved 8MP camera smart glasses | Camera/audio AI glasses | Commercial lead; needs evidence | Resolve regulatory identity, app, Bluetooth name, chipset and OEM lineage before admission | [Amazon ASIN B0GTYKGR5X](https://www.amazon.com/dp/B0GTYKGR5X) |

## Registry rules

- Prefer a manufacturer, project, regulatory, repository, or archived primary source.
- Keep seller pages labeled `commercial`; repeated listings may share one upstream claim.
- Record aliases and rebrands rather than counting them as independent proof.
- Do not copy specifications into this registry until the source and model revision are explicit.
- A dedicated chapter is earned by substantive content, not by market prominence.
- Discontinued models remain in scope because software, protocols, design history, and community work may still matter.
