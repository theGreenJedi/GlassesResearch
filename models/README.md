...
- [**Manufacturer Completeness Wave 01**](THE_LIST_RECONCILIATION_2026-09-05_MANUFACTURER_WAVE_01.md) — RayNeo/TCL, Epson, VITURE, INMO and Lucyd admissions and identity holds.
- [**Manufacturer Completeness Wave 02**](THE_LIST_RECONCILIATION_2026-09-05_MANUFACTURER_WAVE_02.md) — Vuzix, XREAL/Nreal, Meta, Snap and Solos reconciliation, including legacy display-eyewear recovery and explicit variant non-admissions.
...
| [Bose Frames family](BoseFrames/README.md) | GLS-0013–0017 | Alto/Rondo and Tempo/Tenor/Soprano generations, battery, audio hardware, Bluetooth, sensors, apps and lifecycle. |
| [Razer Anzu](RazerAnzu/README.md) | GLS-0018 | Audio hardware, Bluetooth, battery, lenses, mobile app and legacy support. |
| [HUAWEI Eyewear 2](HuaweiEyewear2/README.md) | GLS-0021 | Battery, Bluetooth, sensors, IP54 rating, audio system, controls and frame variants. |
...
| [Solos historical HUD + AirGo 1](SolosHistorical/README.md) | GLS-0214–0216 | 2016/2018 HUD generations, acquisition history, architecture split and the missing first AirGo generation. |
| [Solos AirGo A5](SolosAirGoA5/README.md) | GLS-0217 | Fifth-generation identity, current manufacturer route and AI/app/owner-control investigation queue. |
...
| [Vuzix legacy display eyewear](VuzixLegacyDisplay/README.md) | GLS-0195–0211 | M920, AV, Wrap and STAR purchaser-history recovery, scope rationale and generation-specific evidence queues. |
...
| [Vuzix M400-C](VuzixM400C/README.md) | GLS-0212 | Host-driven USB-C M-Series split, acquisition evidence and independent owner-control/compatibility queue. |
...
| [ROG XREAL R1](XREALR1/README.md) | GLS-0213 | 2026 preorder identity, 240 Hz gaming claim boundary, dock separation and generic-host/owner-control investigation. |
