...
| Mijia Glasses Camera — GLS-0023 | **Identity strongly corroborated in EV-0062.** The 2022 camera/display product is separate from the 2023 audio branch; a certificate index and peer-reviewed use record associate it with model `MJSV01FC`. | Recover the direct Bluetooth certificate and manufacturer manual; preserve connectivity, battery, app, firmware and service-survival evidence before detailed scoring. |
