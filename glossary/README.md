...
- [CMP-0002 — Allwinner V821L2](components/CMP-0002-allwinner-v821l2.md)

### Applications
- [APP-0001 — HeyCyan](applications/APP-0001-hecyan.md)

### Standards and registries
- [STD-0001 — Bluetooth SIG](standards/STD-0001-bluetooth-sig.md)
- [STD-0002 — FCC Equipment Authorization](standards/STD-0002-fcc-equipment-authorization.md)

## Entry expectations

Each page should state what the entity is, why it matters, what is known, what remains uncertain, relevant hyperlinks, related investigations, related models, and the date links were last checked.
