# ORG-0001 — Shenzhen Qingcheng Future Technology / HeyCyan

## Identity

- **Type:** Application and service operator
- **Known name:** Shenzhen Qingcheng Future Technology Co., Ltd. (深圳市青橙未来科技有限公司)
...
- [Google Play search for HeyCyan](https://play.google.com/store/search?q=HeyCyan&c=apps) — fastest public route to the current Android listing and developer details.
- [Google search for the exact company name](https://www.google.com/search?q=%22Shenzhen+Qingcheng+Future+Technology%22) — useful for corporate pages, privacy policies, mirrors, and support references.
- [GitHub search for the observed package name](https://github.com/search?q=%22com.glasssutdio.wear%22&type=code) — useful for APK-analysis notes, leaked strings, integrations, or reverse-engineering work.
