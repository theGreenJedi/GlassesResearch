...
- Imagery acquisition stop boundary remains active. 126 models are currently missing, but that number is a first-pass remainder, not an exhausted-shortcut result. Run a systematic per-model search across admitted locator domains before declaring shortcut failure. Do not begin broader/outside-shortcut searching until Pete provides or declines additional shortcut ideas.
