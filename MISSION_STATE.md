...
- Imagery acquisition stop boundary reached 2026-09-21: 135 models remain outside current locator-network coverage. Do not begin broader/outside-shortcut searching until Pete provides or declines additional shortcut ideas.

## Latest coverage numbers
Generated 2026-09-21 from canonical `models/THE_LIST.md` and `data/model-visuals.json` after the full locator-network pass over the original 175 missing models:
- Canonical models: 246
- Registry records: 246
- Cleared locally preserved originals: 35
- Candidate records: 76
- Missing records: 135
- Shortcut-network promotions from the original missing set: 40
- Models still outside shortcut coverage: 135
...
2026-09-21 — The Phase 1 locator network was applied to all 175 models that were missing imagery at the start of this pass. 40 exact/defensible matches were found and promoted to governed candidates. 135 remain outside shortcut coverage. Broader/manual/outside-network searching is explicitly paused for owner input.
