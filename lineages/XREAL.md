...
### Nreal Light / early spatial AR

Nreal Light represents the early spatial-AR branch rather than a simple cinema display. Its sensors, spatial software and developer role should not be flattened into later Air-series behavior.

### Air family

Air, Air 2, Air 2 Pro and Air 2 Ultra are host-driven personal-display/XR glasses with materially different optical, sensor and spatial-feature packages. The family is close enough for comparative lineage work but not for automatic score inheritance.
...
Beam, Beam Pro, XREAL Eye, Hub products, prescription inserts, adapters, carrying accessories, docks and retail bundles are recorded as ecosystem components rather than extra eyewear models unless future evidence establishes a distinct glasses identity.
