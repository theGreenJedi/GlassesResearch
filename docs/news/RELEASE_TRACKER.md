...
## Upcoming dated verification checkpoints

These are **research appointments, not release claims**. Each date comes from a first-party source and tells GlassesResearch when to re-check the relevant evidence boundary.
