...
|---|---|---|---|---|---|
| [xg.glass](https://github.com/hkust-spark/xg-glass-sdk) | Community universal smart-glasses API intended to reduce per-vendor integration work | Current project documentation lists Rokid, Meta Wearables, Brilliant Labs Frame, RayNeo, INMO, Omi, Even Realities G1, and a simulator. Hardware-validation state varies by adapter; for example RayNeo X2 is listed validated while X3 Pro, INMO Air3, Even G1 and several other paths remain explicitly untested or pending validation. | Android, iOS, and CLI; current project docs specify Android minSdk 28, higher minimums for some adapters, iOS 16+, and Python CLI tooling | Some adapters still depend on vendor components, accounts, frameworks, or proprietary transports; capability and validation boundaries must be checked per device | **Community software evidence.** High-interest portability layer, but its own validation matrix must travel with any capability claim and it must not be promoted to official SDK status. |
