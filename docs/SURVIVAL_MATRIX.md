...
| W610 / HeyCyan variants | Physical glasses and some device functions may remain | Exact app/cloud dependency is still under hands-on investigation | No independently verified public SDK | Unknown | Low purchase price makes preservation research practical, but survival should not be assumed. |
