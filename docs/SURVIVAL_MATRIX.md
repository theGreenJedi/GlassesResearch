...
| Ray-Ban Meta / Oakley Meta | Passive optics and some phone-peripheral/local-storage value remain | Activation, media management, settings, updates and defining visual AI require Meta account/app/services; Gen 2 has narrow offline translation packs | No general owner hardware/firmware path documented | Dependent with limited local residue | Function split and remaining offline tests are documented in [EV-0045](../evidence/EV-0045-Meta-RayBan-Oakley-service-survival.md). |
| Even Realities G1/G2 | Passive optics survive; G1 buffers QuickNote offline; G2 has recoverable phone-hosted HUD potential | First-party pairing uses app/login; Conversate requires phone internet; translation/navigation/AI use network services | Official G2 demo, BLE examples and MIT Even Hub templates exist | G1 dependent; G2 potentially recoverable with preserved host software | [EV-0046](../evidence/EV-0046-Even-G1-G2-service-survival.md) separates host-level openness from service-backed features. |
| RayNeo X3 Pro | Standalone AIOS, storage, capture, selected Android apps and local wake/basic scene detection provide substantial residue | Gemini reasoning, connected translation/navigation/news and provider-backed summaries remain service-dependent | Creator Mode supports Unity/Android ARDK, 6DoF and SLAM; system firmware remains closed | Recoverable local application platform with cloud-dependent defining AI | [EV-0048](../evidence/EV-0048-RayNeo-X3-Pro-service-survival.md) separates Creator Mode from firmware ownership and Gemini dependence. |
| Rokid Glasses | Passive optics survive; Bluetooth/capture residue is plausible; six-language offline translation is pre-provisioned | First activation, model download, media management, settings and updates use Hi Rokid/account; broader AI/navigation/translation use services | Terminal SDK exists, but owner firmware/system replacement is not established | Recoverable with pre-provisioned local functions; defining AI remains dependent | [EV-0047](../evidence/EV-0047-Rokid-Glasses-service-survival.md) separates genuine offline translation from the activation and service gate. |
| MentraOS-compatible devices | Hardware-dependent | Cross-device software can reduce dependence on one vendor application | Strong where supported | Potentially high | Public host SDKs, glasses-side commands and version-linked OTA manifests strengthen recovery; default SDK telemetry must be explicitly disabled for telemetry-minimized deployments. [EV-0060](../evidence/EV-0060-Mentra-Bluetooth-SDK-OTA-owner-control.md) records the verified path and its limits. |
| Xiaomi AI Glasses | Local camera/audio/storage hardware established | Headline multimodal AI, translation and transcription processing location remains unknown; activation/app/region boundaries untested | No broad public SDK or owner recovery image located | Limited local residue; defining AI service survival unresolved | [EV-0067](../evidence/EV-0067-Xiaomi-AI-Glasses-service-survival.md) keeps hardware locality separate from inference locality. |
...
| HoloLens 1 / 2 | Strong local application survival when provisioned | HoloLens 1 continues after support; HoloLens 2 supports local-account offline provisioning, USB/Device Portal app installs and pre-downloaded FFU recovery | UWP/Windows local deployment documented | Moderate to high, with default OOBE/account and security-aging exposure | [EV-0066](../evidence/EV-0066-HoloLens-service-survival.md) separates default cloud-first setup from deliberate offline preservation. |
...
| RealWear HMT-1 / HMT-1Z1 | Strong for local device use | Vendor says EOL units still work; final firmware 12.6; English/German/Mandarin dictation remains local | Android application path survives with aging risk | Moderate | EV-0037 and GLS-0101/0102 preserve the graceful-EOL boundary; third-party app and security decay remain. |
